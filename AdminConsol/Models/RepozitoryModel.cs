...
{
    class RepozitoryModel<T> : IRepozitoryModel<T>
    {
        //
        ...
        public async Task<ObservableCollection<T>> GetListData()
        {
            TokenAccount.Аuthenticator();
        ...
        public async Task<string> AddData(T _modelData)
        {
            TokenAccount.Аuthenticator();
            using (_clientHttp = TokenAccount.CreateTokenClient())
            {
        ...
        public async Task<string> EditData(T _modelData)
        {
            TokenAccount.Аuthenticator();
            using (_clientHttp = TokenAccount.CreateTokenClient())
            {
        ...
        public async Task<string> DeleteData(string _id)
        {
            TokenAccount.Аuthenticator();
            using (_clientHttp = TokenAccount.CreateTokenClient())
            {
